    ...
    return (
        <div className='space-y-4'>
            ...
            <div className='flex gap-2'>
                ...
                <button onClick={addSkill} disabled={!newSkill.trim} className='flex items-center gap-2 px-3 py-2 text-sm text-green-700 rounded-lg hover:bg-green-200 transition-colors disabled:opacity-50 disabled:cursor-not-allowed'>
